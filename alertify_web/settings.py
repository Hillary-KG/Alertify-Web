"""
Django settings for alertify_web project.
...
SECRET_KEY = 'ux-3yli!ok8ijeq&dso8pb8c^d)ptou8)7gcmm^87&rgntxqlu'
...
ROOT_URLCONF = 'alertify_web.urls'
...
WSGI_APPLICATION = 'alertify_web.wsgi.application'
